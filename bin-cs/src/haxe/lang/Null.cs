...
namespace haxe.lang {
	public struct Null<T> {
		...
		public Null(T v, bool hasValue) {
			#line 61 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Null.hx"
			...
			#line 65 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Null.hx"
			this.@value = v;
		...
		public object toDynamic() {
			...
			#line 87 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Null.hx"
			return null;
		}
		#line default
